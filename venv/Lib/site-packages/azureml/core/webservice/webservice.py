...
class Webservice(ABC):
    ...
    @staticmethod
    def _support_resource_check(payload):
        if payload and 'computeType' in payload and payload['computeType'] == AKS_WEBSERVICE_TYPE:
            return True
    ...
    def _check_for_compute_resource(workspace, payload, request_func=None, check_func=None):
        if not Webservice._support_resource_check(payload):
            return
