...
class LinkedService(object):
    ...
    def register(workspace,
        ...
        :type name: str
        :param linked_service_resource_id: The resource id of the linked service.
        :type linked_service_resource_id: str
        ...
        if not linked_service_resource_id:
            raise UserErrorException(
                'linked_service_resource_id cannot be None or empty string.')
