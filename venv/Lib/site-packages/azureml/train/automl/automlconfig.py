...
from azureml.train.automl._local_managed_utils import (
    handle_script_run_error,
    is_docker_installed,
    prepare_managed_inputs)
...
def _local_managed(experiment: Experiment,
    ...
    try:
        with tempfile.TemporaryDirectory() as local_path:
            parent_run, dataset_args, settings, run_config = prepare_managed_inputs(
                experiment, local_path, settings_obj, fit_params, run_config)
            if show_output:
        ...
        if show_output:
            try:
                ...
                handle_script_run_error(parent_run, script_run)
        ...
        with logging_utilities.log_activity(
            ...
            while script_run.get_status() not in automl_started_states:
                time.sleep(5)
        # It takes some milliseconds between script run going into running state, and error handling to kick in
    ...
    def __init__(self,
        ...
        try:
            ...
            if is_prod() or force_curated_environment:
                ...
                self.user_settings["scenario"] = constants.Scenarios._NON_PROD
